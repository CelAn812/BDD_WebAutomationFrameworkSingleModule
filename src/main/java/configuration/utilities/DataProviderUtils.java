...
public class DataProviderUtils {
    ...
    public void testDataProviderUsingExcel(String firstName, String email,String password,String rePassword) throws InterruptedException {
        System.out.println("keyWord1 :"+firstName +" keyWord2 :"+email+" keyWord3 :"+password+" keyWord4 :"+rePassword);
        GlobalReUsableMethods.enterValueOfElement(AboutPage.about,firstName);
        GlobalReUsableMethods.enterValueOfElement(AboutPage.about,email);
        GlobalReUsableMethods.enterValueOfElement(AboutPage.about,password);
        GlobalReUsableMethods.enterValueOfElement(AboutPage.about,rePassword);
    }
