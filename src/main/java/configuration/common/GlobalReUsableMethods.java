...
public class GlobalReUsableMethods extends WebTestBase {
    ...
    public static void enterValueOfElementByXpath(String locator, String value) {
    ...
    public static void enterValueOfElement(WebElement element, String value) throws InterruptedException {
        element.clear();
        Thread.sleep(3000);
    ...
    //Interview Questions
    //Implicit Wait: Indirect wait
    //Explicit Wait: Direct wait
    //Fluent Wait: Conditional wait till the time-out
...
//      element.click();//ele.click()???
        return element;
    }

    public static WebElement explicitWaitForElement(WebElement ele) {
        WebDriverWait webDriverWait = new WebDriverWait(driver, Duration.ofSeconds(20));
        WebElement element = webDriverWait.until(ExpectedConditions.visibilityOf(ele));
//      element.click();//ele.click()???
        return element;
...
//      element.click();//ele.click()???
    ...
    public static WebElement fluentWaitUntilCondition(WebElement ele) {
    ...
    public static WebElement fluentWaitUntilConditionUsingLambda(WebElement ele) {
        Wait<WebDriver> fluentWait = new FluentWait<>(driver)
                .withTimeout(Duration.ofSeconds(60))
                .pollingEvery(Duration.ofSeconds(3)).withMessage("Time out")
                .ignoring(NoSuchElementException.class);
    ...
    public void clickOnElement(String locator) {//it will cross-check with multiple locators but takes time if it has to through an exception
        try {
            driver.findElement(By.xpath(locator)).click();
        } catch (Exception e) {
            try {
    ...
    public static List<String> getListOfString(List<WebElement> elements) {
        ...
        for (WebElement elet : elements) {
            elementList.add(elet.getText());
        }
        return elementList;
    }
    ...
    public static void mouseHoverByXpath(String locator) {
        ...
        try {
            ...
            printLog("First attempt is done, this is second try");
